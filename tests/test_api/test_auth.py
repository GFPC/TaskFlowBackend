...
class TestAuthLogin:
    ...
    def test_login_verified_user_success(self, verified_user):
        ...
        response = client.post(
            '/api/v1/auth/login',
            json={'username': 'ivan_verified', 'password': 'Password123'},
        )
    ...
    def test_login_unverified_user_success(self, unverified_user):
        ...
        response = client.post(
            '/api/v1/auth/login',
            json={'username': 'petr_unverified', 'password': 'Password123'},
        )
    ...
    def test_login_wrong_password(self, verified_user):
        ...
        response = client.post(
            '/api/v1/auth/login',
            json={'username': 'ivan_verified', 'password': 'WrongPassword'},
        )
...
class TestPasswordRecovery:
    ...
    def test_initiate_recovery_success(self, test_user):
        ...
        response = client.post(
            '/api/v1/auth/recovery/initiate', json={'username': 'test_user'}
        )
    ...
    def test_initiate_recovery_user_not_found(self):
        ...
        response = client.post(
            '/api/v1/auth/recovery/initiate', json={'username': 'nonexistent'}
        )
    ...
    def test_reset_password_success(self, test_user):
        ...
        response = client.post(
            ...
            json={'recovery_code': recovery.code, 'new_password': 'NewPassword123!'},
        )
        ...
        assert bcrypt.checkpw(
            'NewPassword123!'.encode('utf-8'), user.password_hash.encode('utf-8')
        )
    ...
    def test_reset_password_invalid_code(self):
        ...
        response = client.post(
            '/api/v1/auth/recovery/reset',
            json={'recovery_code': 'invalid-code', 'new_password': 'NewPassword123!'},
        )
