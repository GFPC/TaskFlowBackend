...
class TestProjectsLive:
    ...
    def setup_method(self):
        ...
        self.owner_id = self.register_user(
            self.owner_username, self.owner_password, self.owner_email, 'Owner', 'Test'
        )
    ...
    def create_test_team(self):
        ...
        response = requests.post(
            ...
            json={'name': self.team_name, 'description': 'Test team for project tests'},
        )
    ...
    def ensure_member_in_team(self, username):
        ...
        members_response = requests.get(
            f'{BASE_URL}/teams/{self.team_slug}/members', headers=self.owner_headers
        )
    ...
    def test_2_create_project_invalid_name(self):
        ...
        response = requests.post(
            f'{BASE_URL}/projects',
            headers=self.owner_headers,
            json={'name': 'A', 'team_slug': self.team_slug},
        )
        ...
        response = requests.post(
            f'{BASE_URL}/projects',
            headers=self.owner_headers,
            json={'name': 'A' * 201, 'team_slug': self.team_slug},
        )
        assert response.status_code == 422
    ...
    def test_3_create_project_unauthorized(self):
        ...
        response = requests.post(
            f'{BASE_URL}/projects',
            json={'name': 'Test Project', 'team_slug': self.team_slug},
        )
    ...
    def test_4_create_project_no_permission(self):
        ...
        response = requests.post(
            ...
            json={'name': f'Project {random_string()}', 'team_slug': self.team_slug},
        )
    ...
    def test_6_create_project_duplicate_name(self):
        ...
        response1 = requests.post(
            f'{BASE_URL}/projects',
            headers=self.owner_headers,
            json={'name': project_name, 'team_slug': self.team_slug},
        )
    ...
    def test_7_get_my_projects(self):
        ...
        response = requests.get(f'{BASE_URL}/projects', headers=self.owner_headers)
    ...
    def test_8_get_team_projects(self):
        ...
        response = requests.get(
            f'{BASE_URL}/projects/team/{self.team_slug}', headers=self.owner_headers
        )
    ...
    def test_9_get_team_projects_not_member(self):
        ...
        response = requests.get(
            f'{BASE_URL}/projects/team/{self.team_slug}', headers=self.member_headers
        )
        assert response.status_code == 403
        assert 'not a member' in response.text.lower()
    ...
    def test_10_get_project_by_slug_success(self):
        ...
        response = requests.get(
            f'{BASE_URL}/projects/{self.project_slug}', headers=self.owner_headers
        )
    ...
    def test_12_get_project_by_slug_not_member(self):
        ...
        response = requests.get(
            f'{BASE_URL}/projects/{self.project_slug}', headers=self.member_headers
        )
    ...
    def test_14_update_project_no_permission(self):
        ...
        add_to_project_response = requests.post(
            ...
            headers=self.owner_headers,
            json={'username': self.member_username, 'role': 'developer'},
        )
    ...
    def test_15_add_member_success(self):
        ...
        add_to_team_response = requests.post(
            f'{BASE_URL}/teams/{self.team_slug}/members',
            headers=self.owner_headers,
            json={'username': self.member_username, 'role': 'member'},
        )
    ...
    def test_18_add_member_no_permission(self):
        ...
        response = requests.post(
            f'{BASE_URL}/projects/{self.project_slug}/members',
            headers=self.member_headers,
            json={'username': self.owner_username, 'role': 'developer'},
        )
        assert response.status_code == 403
        assert "don't have permission" in response.text.lower()
    ...
    def test_27_save_project_graph(self):
        ...
        get_response = requests.get(
            f'{BASE_URL}/projects/{self.project_slug}/graph', headers=self.owner_headers
        )
    ...
    def test_28_get_project_stats(self):
        ...
        response = requests.get(
            f'{BASE_URL}/projects/{self.project_slug}/stats', headers=self.owner_headers
        )
        assert response.status_code == 200
        data = response.json()
