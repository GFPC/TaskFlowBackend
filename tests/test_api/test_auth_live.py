...
class TestAuthLive:
    ...
    def test_4_login_wrong_password(self):
        ...
        response = requests.post(
            f'{BASE_URL}/api/v1/auth/login',
            json={'username': self.username, 'password': 'WrongPassword123!'},
        )
    ...
    def test_5_login_user_not_found(self):
        ...
        response = requests.post(
            f'{BASE_URL}/api/v1/auth/login',
            json={'username': 'nonexistent_user_123456', 'password': 'Password123!'},
        )
    ...
    def test_10_reset_password_invalid_code(self):
        ...
        response = requests.post(
            ...
            json={'recovery_code': 'invalid_code_12345', 'new_password': 'NewPass123!'},
        )
