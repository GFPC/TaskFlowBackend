...
class TestTasksLive:
    ...
    def setup_method(self):
        ...
        self.assignee_token = self.login_user(
            self.assignee_username, self.assignee_password
        )
    ...
    def create_test_team(self):
        ...
        response = requests.post(
            ...
            json={'name': self.team_name, 'description': 'Test team for task tests'},
        )
    ...
    def add_member_to_project(self, username, role):
        ...
        assert response.status_code == 200, (
            f'Failed to add {username} to project: {response.text}'
        )
...
class TestTaskCreation(TestTasksLive):
    ...
    def test_2_create_task_without_assignee(self):
        ...
        response = requests.post(
            f'{BASE_URL}/projects/{self.test_project_slug}/tasks',
            headers=self.owner_headers,
            json={'name': task_name, 'project_slug': self.test_project_slug},
        )
    ...
    def test_3_create_task_invalid_name(self):
        ...
        response = requests.post(
            f'{BASE_URL}/projects/{self.test_project_slug}/tasks',
            headers=self.owner_headers,
            json={'name': '', 'project_slug': self.test_project_slug},
        )
    ...
    def test_4_create_task_no_permission(self):
        ...
        self.register_user(
            observer_username, observer_password, observer_email, 'Observer', 'Test'
        )
        ...
        response = requests.post(
            ...
            headers=self.owner_headers,
            json={'username': observer_username, 'role': 'observer'},
        )
        assert response.status_code == 200
...
class TestDependencyActions(TestTasksLive):
    ...
    def test_24_add_change_status_action(self):
        ...
        response = requests.post(
            ...
            # <-- ИСПРАВЛЕНО!
            headers=self.owner_headers,
            json={'action_type_code': 'change_status', 'target_status': 'in_progress'},
        )
...
class TestTaskReadiness(TestTasksLive):
    ...
    def test_28_task_readiness_chain(self):
        ...
        print(
            f'     Dependencies: {len(data_a.get("incoming_dependencies", []))} incoming'
        )
        ...
        print(
            f'     Dependencies: {len(data_b.get("incoming_dependencies", []))} incoming'
        )
        ...
        print(
            f'     Dependencies: {len(data_c.get("incoming_dependencies", []))} incoming'
        )
...
class TestTaskEdgeCases(TestTasksLive):
    ...
    def test_35_create_task_invalid_project(self):
        ...
        response = requests.post(
            ...
            headers=self.owner_headers,
            json={'name': 'Invalid Task', 'project_slug': 'non-existent-project'},
        )
        assert response.status_code == 404
    ...
    def test_36_create_dependency_same_task(self):
        ...
        response = requests.post(
            ...
            headers=self.owner_headers,
            json={'source_task_id': task['id'], 'target_task_id': task['id']},
        )
    ...
    def test_37_add_action_without_required_fields(self):
        ...
        dep_response = requests.post(
            ...
            headers=self.owner_headers,
            json={'source_task_id': task1['id'], 'target_task_id': task2['id']},
        )
        assert dep_response.status_code == 200
        ...
        response = requests.post(
            ...
            headers=self.owner_headers,
            json={'action_type_code': 'notify_custom', 'message_template': 'Test'},
        )
